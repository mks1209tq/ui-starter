<div class="lg:flex lg:items-center lg:justify-between">
    ...
    <div class="mt-5 flex lg:ml-4 lg:mt-0">
        ...
        <span class="sm:ml-3">
            ...
            <a href="#"
                class="inline-flex items-center rounded-md bg-blue-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900">
